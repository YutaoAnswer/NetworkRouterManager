...
public class RecyclerDataAdapter extends RecyclerView.Adapter<RecyclerDataAdapter.MyViewHolder> {
    ...
    public RecyclerDataAdapter(ArrayList<DummyParentDataItem> dummyParentDataItems, Handler handler) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.tv_parentName) {
                ...
                // TODO: 19-7-31 打开新的Fragment
                Message msg = Message.obtain();
                msg.what = 1; // 消息标识
                msg.obj = textViewClicked.getText().toString(); // 消息内存存放
