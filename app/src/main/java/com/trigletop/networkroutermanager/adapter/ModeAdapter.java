...
public class ModeAdapter extends RecyclerView.Adapter<ModeAdapter.HostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HostViewHolder holder, int position) {
        holder.textview.setText(Data.host_mode_data[position]);
        // item click
    ...
    public int getItemCount() {
        return Data.host_mode_data.length;
    }
